...
const Navbar = () => {
  ...
  <li><Link to='/add-timeslot'>Add Time Slot</Link></li>
  ...
  <div className="navbar-end ">
    <button className="btn btn-ghost btn-circle">
      <div className="dropdown relative">
        ...
        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-blue-900 rounded-box w-52 right-0"> {/* Changed color to red */}
          <li><Link to='/main'>Main Page</Link></li>
          <li><Link to='/'>Logout</Link></li>
        </ul>
      </div>
